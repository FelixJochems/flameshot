...
{
    m_countingCircleNoContrast = new QCheckBox(tr("Disable Counting bubble contrast"), this);
    m_countingCircleNoContrast->setToolTip(
      tr("Disable the contrasting circle that is around the Counting circle bubbles"));
